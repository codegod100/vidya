...
pub use layout::{
    ...
    format_bps, format_rate, grid, grid_cols, hflow, inset_row, lead_trail, measure_mono_caption,
    metric_bps, metric_cell, metric_cell_px, metric_rate, pack, pad_metric, page_body,
    side_by_side, table_metric, table_text, two_col, vstack, Col, ColKind, ColSpec, GridCtx,
    RowDsl, METRIC_BPS_CHARS, METRIC_RATE_CHARS,
};
pub use theme::{
